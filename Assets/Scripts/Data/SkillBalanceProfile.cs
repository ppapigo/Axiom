...
namespace Axiom.Data
{
    ...
    public sealed class SkillBalanceProfile : ScriptableObject
    {
        ...
        [SerializeField, Min(0f)] private float waterLightningDuration = 3f;
        [SerializeField, Min(0f)] private float waterLightningAttackCoefficient = 0.06f;
        [SerializeField, Min(0f)] private float waterLightningStunDuration = 0.5f;
        ...
        public float WaterLightningDuration => waterLightningDuration;
        public float WaterLightningAttackCoefficient => waterLightningAttackCoefficient;
        public float WaterLightningStunDuration => waterLightningStunDuration;
        ...
        private void OnValidate()
        {
            ...
            waterLightningDuration = Mathf.Max(0f, waterLightningDuration);
            waterLightningAttackCoefficient = Mathf.Max(0f, waterLightningAttackCoefficient);
            waterLightningStunDuration = Mathf.Max(0f, waterLightningStunDuration);
