...
현재 Unity EditMode 테스트 75개와 PlayMode 데모 스모크 테스트 1개가 모두 통과합니다.
...
화상·독·물 회복 등 속성 상태효과와 속성 조합을 전투에 적용하고, 이후 AI 자연어 요청을 검증된 `SkillDefinition`으로 변환하는 생성 계층을 추가합니다.
