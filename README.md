...
기존 Unity EditMode 전체 테스트 103개와 자연어 스킬 생성 계층 대상 테스트 5개가 통과합니다. 최신 PlayMode 재실행은 권한 거부로 생략했습니다.
...
AI 응답 DTO를 `SkillDraft`로 변환하는 Mapper와 100포인트·역할 규칙 Validator, Auto Corrector를 추가합니다.
