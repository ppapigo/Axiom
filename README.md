...
현재 Unity EditMode 테스트는 29개이며 모두 통과합니다.
...
2. `Create > Axiom > Role > Tank Definition`으로 Tank 역할 데이터를 생성합니다.
...
Mage 역할을 구현합니다. HP 900, Attack 115, 이동 배율 1.0, 4m 회피와 12초 쿨다운을 적용하고 광역 피해 상한 규칙을 역할 정책으로 추가합니다.
